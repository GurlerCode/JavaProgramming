...
public class Engine {
    ...
    public boolean workingEngine(){
        return this.enoughSealPower() && this.enoughOil();
    }

    //TODO 2.3: Implement the function enoughSealPower()
    public boolean enoughSealPower() {
        return (sealPower > 0 && sealPower % 3 == 0) ? true : false;
    }

    //TODO 2.4: Implement the function enoughOil()
    public boolean enoughOil() {
        return this.oilAmount > 2000;
    }
