...
public class Seal {
    ...
    public Seal(String name, short age, float heightInCm, boolean driversLicense,
    ...
    public static void updateCrashCount(int newCrashcount){
